...
void info_arquero() const {
cout << " Arco : " << arco_ << endl;
cout << " Precision: " << precision_ << endl;
}
void atacar() const override {
cout << nombre_ << " dispara con " << arco_ << endl;
cout<<" Precision: "<<precision_<<endl;
cout << " Dano fisico: " << precision_ * 3<< endl;
}
private:
string arco_;
int precision_;
...
partida.push_back(new Arquero("Merida", 100, 9, "Arco Familiar", 100));
partida.push_back(new Arquero("Robin", 80, 8, "Arco Defensa", 70));
